  ...
  return (
    <div id='contact' className='section relative w-full work-sans py-20'>
      <div className='h-full w-full flex-col  flex lpy-10 lg:py-0 px-5 lg:px-20 items-center justify-center gap-10 lg:gap-20'>
        <div className='grid grid-rows-3 lg:grid-cols-3  gap-5 flex-col lg:flex-row justify-between text-xl'>
          ...
          <div className='group flex flex-col bg-black/40 lg:hover:bg-black/40 rounded-2xl border lg:bg-tea transition-all duration-500 border-white/20 gap-2 p-5'>
          ...
          <div className='lg:group-hover:text-tea lg:group-hover transition-all duration-500 lg:text-transparent'> <a href='tel:+998994684919' className='underline underline-offset-8'>+998994684919</a> <span className='w-5 h-3 lg:h-0 flex lg:inline-block'></span> <a href='tel:+998911499913' className='underline underline-offset-8'>+998911499913</a></div>
          </div>
          <div className='flex flex-col bg-black/40 rounded-2xl border border-white/20 gap-2 p-5'>
